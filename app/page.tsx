...
export default function Home() {
  ...
  const handleSearch = () => {
    if (searchQuery.trim()) {
      ...
      navigate(
        `/medicines?search=${encodeURIComponent(searchQuery.trim())}`,
        '약 정보를 검색하고 있어요...'
      );
    }
  };
  ...
  return (
    <div className="flex flex-col">
      {/* Hero Section */}
      <section className="relative w-full min-h-[100vh] bg-gradient-to-br from-teal-50 via-white to-teal-100 overflow-hidden">
        ...
        <div className="container px-4 md:px-6">
          <div className="text-center space-y-8">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              아플 때, 약알고를 열면
              <br />
              <span style={{ color: '#4FC4B8' }} className="font-semibold">
                약국이 우리를 찾아올 거예요.
              </span>
            </p>
                    ...
                    <Button
                      ...
                      onClick={() =>
                        navigate(
                          ...
                          `${features[currentFeature].title} 페이지로 이동하고 있어요...`
                        )
                      }
                    >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="bg-white border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 mb-6">
                  내 위치 기반으로 가까운 약국을 찾고 영업시간과 재고를 확인하세요.
                </p>
            ...
            <Card className="bg-white border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 mb-6">
                  궁금한 점이 있다면 약사나 의사에게 직접 질문하고 답변을 받으세요.
                </p>
