...
export const editorTheme: EditorThemeClasses = {
  ...
  paragraph: 'leading-7 [&:not(:first-child)]:mt-1',
  ...
  list: {
    ...
    nested: {
      listitem: 'ml-2 mt-0 list-none before:hidden after:hidden',
    },
    ol: '[&:not(:first-child)]:mt-1 ml-3 list-decimal [&>li]:mt-2',
    olDepth: [
    ...
    ul: '[&:not(:first-child)]:mt-1 ml-3 list-disc list-outside [&>li]:mt-2',
  },
