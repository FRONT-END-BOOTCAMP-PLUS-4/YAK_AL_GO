                  ...
                  {selectedItemSeq && (
                    <div className="text-sm text-muted-foreground mt-1">
                      <Badge variant="outline">
                        {allMedicines.find((m) => m.item_seq === selectedItemSeq)?.item_name ??
                          '선택된 약품'}
                      </Badge>
                    </div>
                  )}
                          ...
                          >
                            {editingItem === item.id ? (
                              ...
                              <>
                                ...
                                <div className="text-sm">{item.company}</div>
                                <div className="text-sm">{item.type}</div>
                                <div className="text-sm text-center">{item.stock}</div>
                      ...
                      lowStockItems.map((item) => (
                        ...
                        >
                          <div>
                            ...
                            <p className="text-xs text-muted-foreground">현재: {item.stock}</p>
                          </div>
                          <Button
                            size="sm"
                            variant="outline"
